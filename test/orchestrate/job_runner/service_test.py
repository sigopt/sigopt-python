...
class TestJobRunnerService(object):
  ...
  @pytest.mark.parametrize('resources,expected_output', [
      (
        dict(requests={'cpu': 5}),
        dict(requests={'cpu': 5, "ephemeral-storage": JobRunnerService.DEFAULT_EPHEMERAL_STORAGE_REQUEST}, limits={}),
      ),
      (
      ...
      (
        dict(requests={'cpu': '1', "ephemeral-storage": "1Ti"}, limits={'memory': '2Gi', 'cpu': 2}, gpus=1),
        dict(
